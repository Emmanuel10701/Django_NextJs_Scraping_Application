        ...
        {loading
          ? Array(8)
              ...
              .map((_, index) => (
                <div
                  key={index}
                  className="animate-pulse shadow-md rounded-lg p-4 bg-white"
                >
          ...
          : products.map((product, index) => (
              <div
                key={index}
                className="shadow-lg rounded-lg overflow-hidden transform hover:scale-105 transition duration-300 bg-white"
              >
                <Image
