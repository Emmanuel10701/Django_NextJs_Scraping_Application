    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
          ...
          >
            <h1
              className={`text-3xl font-extrabold mt-[10%] ${theme === "dark" ? "text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500" : "text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500"} sm:text-4xl mb-4`}
            >
          ...
          >
            ...
            <p className={`text-base ${theme === "dark" ? "text-gray-300" : "text-gray-700"} mb-4`}>
